...
<figure class="recipe-fig">
                <h2 class="recipe-title h2 justify-content-center">${
                  recipe.title
                }</h2>
    ...
    recipe.title
            ...
            <div class="recipe-details justify-content-around">
                <div class="recipe-info">
                    <p class="recipe-info-item recipe-info-data recipe-info-data-minutes">                        <i class="fa fa-clock-o recipe-info-item" aria-hidden="true"></i>${
                      recipe.time
                    } minutes</p>
                </div>
                <div class="recipe-info">
                    <p class="recipe-info-item recipe-info-data recipe-info-data-people">
                        <i class="fa fa-users recipe-info-item" aria-hidden="true"></i>${
                          recipe.servings
                        } servings</p>
                </div>
                ...
                <button type="button" class="btn recipe-like-button">
                    <p>Add to Liked Recipes
                        <i class="fa fa-heart${
                          isLiked ? '' : '-o'
                        } recipe__love" aria-hidden="true"></i>
                    </p>
                </button>
